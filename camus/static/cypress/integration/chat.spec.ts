describe('Create room', () => {
    it('can create and enter a public room', () => {
        ...
        form.get('details').click();

        form.get('select[name="public"]').select('Yes');

        form.get('input[name="submit"]').click();
    ...
    it('can create and enter a non-public room', () => {
        ...
        form.get('select[name="public"]').select('No');
    ...
    it('can create and enter a password-protected room', () => {
        ...
        createForm
            .get('input[name="room_name"]')
            .type(roomName)
            .should('have.value', roomName);

        createForm.get('details').click();
        ...
        createForm.get('input[name="submit"]').click();
