...
describe('Test feeds slice of Redux store', () => {
  ...
  it('can set the local audio', () => {
    ...
    const audioTrack = new RTCPeerConnection().addTransceiver('audio').receiver
      .track;
  ...
  it('can set the local video', () => {
    ...
    const videoTrack = new RTCPeerConnection().addTransceiver('video').receiver
      .track;
